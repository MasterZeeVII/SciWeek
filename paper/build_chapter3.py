...
EVENTS = [
    (1, "ผู้ดูแลระบบสร้างการแข่งขันประจำปีและกำหนดรุ่นการแข่งขัน",
        "บันทึกการแข่งขัน สร้างรุ่นมัธยมศึกษาตอนต้น/ตอนปลาย และเปิดใช้งานการแข่งขันของปีนั้น"),
...
DD = [
    ...
    ("ตารางที่ 3.4 พจนานุกรมข้อมูลตารางการแข่งขัน (tournaments)", [
        ...
        (3, "year", "SMALLINT UNSIGNED", "ปี พ.ศ. ของการแข่งขัน (ห้ามซ้ำ)", "UQ"),
        (4, "is_active", "TINYINT(1)", "สถานะการแข่งขันที่เปิดใช้งาน (เปิดได้ครั้งละ 1 รายการ)", ""),
        (5, "created_at", "DATETIME", "วันเวลาที่สร้างรายการแข่งขัน", ""),
    ]),
...
def build():
    ...
    para(doc, "ระบบใช้ฐานข้อมูลเชิงสัมพันธ์ (MariaDB) ที่ผ่านการทำ Normalization ประกอบด้วยตาราง "
              ...
              "การแข่งขันอ้างอิงผู้ใช้งาน (users) ทั้งผู้อัปโหลดภาพหลักฐานและผู้ยืนยันผล ดังภาพที่ 3.11",
         indent=1.25, space_after=6)
    ...
    para(doc, "พจนานุกรมข้อมูลอธิบายรายละเอียดโครงสร้างของตารางในฐานข้อมูลทั้ง 9 ตาราง "
              ...
              "(Unique) ดังตารางที่ 3.2 ถึงตารางที่ 3.10",
         indent=1.25, space_after=8)
